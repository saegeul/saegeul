...
<div class="admin_sidebar_wrapper">
	<div class=" bs-docs-sidebar">
		<ul class="nav nav-list bs-docs-sidenav affix-top">
                        <li <?php if($action=='checkOauth'):?> class="active" <?endif;?>> 
                            <a href="<?=site_url("clouddrive/admin/clouddrive/checkOauth")?>"><i
			...
			if($oauth_token != null && $oauth_token != ""){
				?>
                        <li <?php if($action=='ucloudView'):?> class="active" <?endif;?>> 
                            <a href="<?=site_url("admin/clouddrive/ucloudView")?>"><i
					class="icon-chevron-right"></i> KTUcloud</a>
			</li>
			<?php }else{?>
                        <li <?php if($action=='checkOauth'):?> class="active" <?endif;?>> 
                            <a href="<?=site_url("admin/clouddrive/checkOauth")?>"><i
					class="icon-chevron-right"></i> KT Ucloud</a>
			</li>
			<?php }?>
			<li>
                            <a><i class="icon-chevron-right"></i>SK Tcloud</a>
			</li>
		</ul>
	</div>
</div>
