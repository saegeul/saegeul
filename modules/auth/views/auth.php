...
$(document).ready(function(){
    ...
    $.ajax({
	       ...
	       success: function(data){
				...
				var markup = "all&nbsp;<input type='checkbox' id='all_img_check'/>&nbsp;<input type='button' value='cloud upload' class='btn'><br><br><ul class='thumbnails'>";
 	   ...
 	       	obj = state;
 	   			markup += "<li class='span2'>"
     	   			...
     	   			+ "<img src='" + obj.thumbnail_url + "' class='img-rounded'>"
     	   			+ "</div>";
 	     	});
	    	   markup += "</ul>"
