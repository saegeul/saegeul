...
<body>
	...
	<div class="row show-grid">
		<ul class="breadcrumb">
			<li>&nbsp;&nbsp;&nbsp;</li>
			<li><a href="/saegeul/auth/getFolder">Ucloud</a> <span class="divider">/</span></li>
		</ul>
	</div>
	<br>
			...
			<tbody>
				...
				<tr onclick="ViewFolder('<?=$folder_id?>')">
					...
					<td><?php if($folder_type == "syncFolder" && $folder_name == "휴지통"){?>
						<img alt="휴지통"
						src="/saegeul/modules/auth/views/assets/img/delete_forlder.png"> <?php }else if($folder_type == "syncFolder" && $folder_name == "웹 폴더"){?>
						<img alt="웹폴더"
