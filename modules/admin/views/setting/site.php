<form action="setting/setupSite" method="post" class="form-horizontal" style="margin-top:30px;">
    <fieldset>
        <div class="control-group">
            <label class="control-label" for="input01">Site 이름</label>
            <div class="controls">
                <input type="text" class="input-xlarge" name="site_name" placeholder="saegeul">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="input-xlarge" name="site_url" placeholder="http://www.saegeul.com">
